...
def main():
    parser = argparse.ArgumentParser(description="Extract individual features for video frames.")
            ...
            for start_idx in range(0, total_frames, clip_length):
                ...
                for i in range(len(frame_indices)):
                    ...
                    if ret:
                        ...
                        logging.warning(f"Cannot read frame {start_idx + i} from {gopro_video}, padding with zeros")
                ...
                individual_features = extract_individual_features(preprocessed_frames, individual_model, device, batch_size=args.feature_extraction_batch_size)
